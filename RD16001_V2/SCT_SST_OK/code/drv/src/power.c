...
unsigned int wakeuptimes = 0;//唤醒次数，用于判断是否到达上传数据的时间间隔

unsigned char UpdateFlag = 0;//数据上传的标志

unsigned char MeasureTimeFlag = 0;//测量数据标志

unsigned int IntervalTime = (unsigned int)INTERVAL_TIME;//采集间隔

...
#define INTERVAL_TIME                           1  //默认时间间隔 单位是min至少需要5分钟
#define CMD_TIME                                20 //默认的cmd等待时间
...
/*rain temp:   1E000*/
//
#define RAIN_ADDR                               0x18000//雨量保存的位置
#define RAIN_TEMP_ADDR                          0x1E000//雨量数据交换的缓冲位置
#define RAIN_NUM_ADDR                           0x1F000//雨量数目的位置

...
void GUIDEMO_Intro(void) {
  ...
  GUI_SetFont(&GUI_Font24B_1);
  GUI_DispStringHCenterAt("ALIENTEK WARSHIP STM32", xCenter, y += 30);
  GUI_SetColor(GUI_LIGHTRED);
  GUI_SetFont(&GUI_Font16_ASCII);
  GUI_DispStringHCenterAt("Press RESET+KEY0 to Adjust!"
                          , xCenter, y += 40);
  ...
  GUI_SetColor(GUI_WHITE);
  GUI_DispStringHCenterAt("www.openedv.com", LCD_GET_XSIZE() / 2, LCD_GET_YSIZE() - 40);
...
void GUIDEMO_Intro(void) {
  ...
  GUI_SetFont(&GUI_Font13B_1);
  GUI_DispStringHCenterAt("http://baiweijishu.taobao.com", LCD_GET_XSIZE() / 2, LCD_GET_YSIZE() - 50);
  GUIDEMO_Delay(5000);

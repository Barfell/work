...
STATIC VOID HandleAutoEraseNandflash(VOID)
{
    ...
    while(1)
    {
        ...
        if(cNAND_ADDRESS_tag.Block == NAND_MAXNUMBER_BLOCK)
        {
            ...
            printf("Nandflash Auto Erase End\r\n"); 
	...
	{	
        ...
        if(GetUsartCurrentLength(USART1_TYPE))
        {
            ...
            if(u16Count == 7)
            {
                ...
                else if((szTestTest[0] == 0x01) && (szTestTest[1] == 0x07) && (szTestTest[2] == 0xEF))//
                {
                    g_u8Data = szTestTest[3];
                    g_u8Page = szTestTest[4];
                    g_u16Block = MAKEWORD(szTestTest[6], szTestTest[5]);
                ...
                else if((szTestTest[0] == 0x01) && (szTestTest[1] == 0x08) && (szTestTest[2] == 0xEF))//
                {
                    g_u8Data = szTestTest[3];
                    g_u8Page = szTestTest[4];
                    g_u16Block = MAKEWORD(szTestTest[6], szTestTest[5]);
                ...
                else if((szTestTest[0] == 0x01) && (szTestTest[1] == 0x09) && (szTestTest[2] == 0xEF))//
                {
                    g_u8Data = szTestTest[3];
                    g_u8Page = szTestTest[4];
                    g_u16Block = MAKEWORD(szTestTest[6], szTestTest[5]);
                    ...
                    printf("Detect bad block over\r\n"); 
                }

				else if((szTestTest[0] == 0x01) && (szTestTest[1] == 0x0c))//
                {
                    g_u8Data = szTestTest[3];
                    g_u8Page = szTestTest[4];
                    g_u16Block = MAKEWORD(szTestTest[6], szTestTest[5]);

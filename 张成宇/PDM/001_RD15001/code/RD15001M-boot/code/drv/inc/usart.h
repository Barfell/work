...
EXTERN U8 *g_pUsart1BackData;    //备份用的环形缓冲      大小由MAXQUEUESIZE来决定
EXTERN U8 *g_pUsart2BackData;    //备份用的环形缓冲      大小由MAXQUEUESIZE来决定
EXTERN U8 *g_pUsart3BackData;    //备份用的环形缓冲      大小由MAXQUEUESIZE来决定

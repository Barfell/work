...
#define put_str(x)							_db_msg(DEBUG_UART_PORT, x)
#define put_str_(x)							_db_msg_(DEBUG_UART_PORT, x)

#define  putchar(x)						    _db_char(DEBUG_UART_PORT, x)
...
#define getkey()							_db_get_key(DEBUG_UART_PORT)
#define getchar()							_db_get_char(DEBUG_UART_PORT)

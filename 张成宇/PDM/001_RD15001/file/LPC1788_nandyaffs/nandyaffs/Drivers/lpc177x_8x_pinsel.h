 ...
 * 				support for Pin connect block firmware library on LPC177x_8x
 * @version		1.0
...
/* Peripheral group ----------------------------------------------------------- */
#ifndef LPC178X_PINSEL_H
#define LPC178X_PINSEL_H
...
typedef enum
{
	PINSEL_I2CMODE_FAST_STANDARD  = 0,	/* Fast mode (400 kHz clock rate) and standard (100 kHz clock rate) */
	PINSEL_I2CMODE_OPENDRAINIO,			/* Open drain I/O (not I2C). No glitch filter, 3 mA typical output drive */
	PINSEL_I2CMODE_FASTMODEPLUS,		/* Fast Mode Plus I2C. This includes a filter for <50 ns glitches */
	PINSEL_I2CMODE_HIDRIVE_OPENDRAIN	/* High drive open drain I/O (not I2C). No glitch filter, 20 mA typical output drive */
}PinSel_I2cMode;
/* Public Functions ----------------------------------------------------------- */

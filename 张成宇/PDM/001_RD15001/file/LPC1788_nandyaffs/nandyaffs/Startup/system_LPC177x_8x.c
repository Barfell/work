...
/* Determine core clock frequency according to settings */
   ...
   #error "Main PLL is selected as clock source but is not enabled!"
    ...
    #else                               /* sysclk = osc_clk */
        #define __CORE_CLK (__PLL0_CLK(OSC_CLK) / __CCLK_DIV)// ×îºóÑ¡ÔñµÄÊÇÕâ¸ö
...
uint32_t SPIFIClock 	 = 0;		  /*!< SPIFI Clock Frequency - this value will be updated
									after call SystemCoreClockUpdate */

...
uint32_t		C_GLCD_PIX_CLK ;          
uint32_t		C_GLCD_H_SIZE ;         
uint32_t		C_GLCD_H_PULSE;        
uint32_t		C_GLCD_H_FRONT_PORCH ;  
uint32_t		C_GLCD_H_BACK_PORCH ; 
uint32_t		C_GLCD_V_SIZE ;         
uint32_t		C_GLCD_V_PULSE;       
uint32_t		C_GLCD_V_FRONT_PORCH;  
uint32_t		C_GLCD_V_BACK_PORCH ;   	   	   
uint32_t		C_GLCD_BytesPP;
...
static uint32_t XR_Win ;
static uint32_t YD_Win ;
 ...
 *
 *************************************************************************/
int GLCD_Init (uint8_t LCD_TYPE)
{
	// Assign pins
	...
	{
	case LCD_320_240 :
		C_GLCD_PIX_CLK         = C_GLCD_320_240_PIX_CLK;
		C_GLCD_H_SIZE          = C_GLCD_320_240_H_SIZE;
 		C_GLCD_H_PULSE         = C_GLCD_320_240_H_PULSE;
		C_GLCD_H_FRONT_PORCH   = C_GLCD_320_240_H_FRONT_PORCH;
		C_GLCD_H_BACK_PORCH    = C_GLCD_320_240_H_BACK_PORCH;
		C_GLCD_V_SIZE          = C_GLCD_320_240_V_SIZE;
		C_GLCD_V_PULSE         = C_GLCD_320_240_V_PULSE;
		C_GLCD_V_FRONT_PORCH   = C_GLCD_320_240_V_FRONT_PORCH;
		C_GLCD_V_BACK_PORCH    = C_GLCD_320_240_V_BACK_PORCH;
		C_GLCD_BytesPP		   = C_GLCD_320_240_BytesPP;
	break;
	
	case LCD_480_272:
		C_GLCD_PIX_CLK         = C_GLCD_480_272_PIX_CLK;
		C_GLCD_H_SIZE          = C_GLCD_480_272_H_SIZE;
 		C_GLCD_H_PULSE         = C_GLCD_480_272_H_PULSE;
		C_GLCD_H_FRONT_PORCH   = C_GLCD_480_272_H_FRONT_PORCH;
		C_GLCD_H_BACK_PORCH    = C_GLCD_480_272_H_BACK_PORCH;
		C_GLCD_V_SIZE          = C_GLCD_480_272_V_SIZE;
		C_GLCD_V_PULSE         = C_GLCD_480_272_V_PULSE;
		C_GLCD_V_FRONT_PORCH   = C_GLCD_480_272_V_FRONT_PORCH;
		C_GLCD_V_BACK_PORCH    = C_GLCD_480_272_V_BACK_PORCH;
		C_GLCD_BytesPP		   = C_GLCD_480_272_BytesPP;
 	break;
	case LCD_800_480:
		C_GLCD_PIX_CLK         = C_GLCD_800_480_PIX_CLK;
		C_GLCD_H_SIZE          = C_GLCD_800_480_H_SIZE;
 		C_GLCD_H_PULSE         = C_GLCD_800_480_H_PULSE;
		C_GLCD_H_FRONT_PORCH   = C_GLCD_800_480_H_FRONT_PORCH;
		C_GLCD_H_BACK_PORCH    = C_GLCD_800_480_H_BACK_PORCH;
		C_GLCD_V_SIZE          = C_GLCD_800_480_V_SIZE;
		C_GLCD_V_PULSE         = C_GLCD_800_480_V_PULSE;
		C_GLCD_V_FRONT_PORCH   = C_GLCD_800_480_V_FRONT_PORCH;
		C_GLCD_V_BACK_PORCH    = C_GLCD_800_480_V_BACK_PORCH;
		C_GLCD_BytesPP		   = C_GLCD_800_480_BytesPP;
	break;
	case LCD_800_600:
		C_GLCD_PIX_CLK         = C_GLCD_800_600_PIX_CLK;
		C_GLCD_H_SIZE          = C_GLCD_800_600_H_SIZE;
 		C_GLCD_H_PULSE         = C_GLCD_800_600_H_PULSE;
		C_GLCD_H_FRONT_PORCH   = C_GLCD_800_600_H_FRONT_PORCH;
		C_GLCD_H_BACK_PORCH    = C_GLCD_800_600_H_BACK_PORCH;
		C_GLCD_V_SIZE          = C_GLCD_800_600_V_SIZE;
		C_GLCD_V_PULSE         = C_GLCD_800_600_V_PULSE;
		C_GLCD_V_FRONT_PORCH   = C_GLCD_800_600_V_FRONT_PORCH;
		C_GLCD_V_BACK_PORCH    = C_GLCD_800_600_V_BACK_PORCH;
		C_GLCD_BytesPP		   = C_GLCD_800_600_BytesPP;

   	break;	
	default:
	break;
 }
	XR_Win = C_GLCD_H_SIZE-1;
	YD_Win = C_GLCD_V_SIZE-1;
...
/*************************************************************************
 * Function Name: GLCD_Dis_Logo
 * Parameters: const uint32_t *pPain, const uint32_t * pPallete
 *
 * Return: none
 *
 * Description: LCD Display logo
 *
 *************************************************************************/
void GLCD_Dis_Logo (const uint8_t *pPain, const uint8_t * pPallete){
       // init colour pallet
	uint32_t i;
	uint8_t *pDst = (uint8_t *)LCD_VRAM_BASE_ADDR;

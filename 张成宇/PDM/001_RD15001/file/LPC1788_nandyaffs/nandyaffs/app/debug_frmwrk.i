...
#line 21 "..\\Drivers\\debug_frmwrk.c"
...
#line 22 "..\\Drivers\\debug_frmwrk.c"
...
uint8_t (*_db_get_key)(LPC_UART_TypeDef *UARTx);
												...
												uint8_t numCh, uint32_t* val)
{
	...
	while (numCh > 0)
	{
		...
		UART_Receive(UARTx, &tmpCh, 1, NONE_BLOCKING);
...
#line 516 "..\\Drivers\\debug_frmwrk.c"

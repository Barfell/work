#line 1 "..\\Drivers\\lpc177x_8x_nvic.c"
...
#line 29 "..\\Drivers\\lpc177x_8x_nvic.c"
...
void NVIC_DeInit(void)
{
	...
	((NVIC_Type *) ((0xE000E000) + 0x0100))->ICER[0] = 0xFFFFFFFF;
	((NVIC_Type *) ((0xE000E000) + 0x0100))->ICER[1] = 0x00000001;
	 
	((NVIC_Type *) ((0xE000E000) + 0x0100))->ICPR[0] = 0xFFFFFFFF;
	((NVIC_Type *) ((0xE000E000) + 0x0100))->ICPR[1] = 0x00000001;

	 
	for (tmp = 0; tmp < 32; tmp++) {
		((NVIC_Type *) ((0xE000E000) + 0x0100))->IP[tmp] = 0x00;
	}
}
...
void NVIC_SCBDeInit(void)
{
	...
	((SCB_Type *) ((0xE000E000) + 0x0D00))->ICSR = 0x0A000000;
	((SCB_Type *) ((0xE000E000) + 0x0D00))->VTOR = 0x00000000;
	((SCB_Type *) ((0xE000E000) + 0x0D00))->AIRCR = 0x05FA0000;
	((SCB_Type *) ((0xE000E000) + 0x0D00))->SCR = 0x00000000;
	((SCB_Type *) ((0xE000E000) + 0x0D00))->CCR = 0x00000000;

	for (tmp = 0; tmp < 32; tmp++) {
		((SCB_Type *) ((0xE000E000) + 0x0D00))->SHP[tmp] = 0x00;
	}

	((SCB_Type *) ((0xE000E000) + 0x0D00))->SHCSR = 0x00000000;
	((SCB_Type *) ((0xE000E000) + 0x0D00))->CFSR = 0xFFFFFFFF;
	((SCB_Type *) ((0xE000E000) + 0x0D00))->HFSR = 0xFFFFFFFF;
	((SCB_Type *) ((0xE000E000) + 0x0D00))->DFSR = 0xFFFFFFFF;
}
...
void NVIC_SetVTOR(uint32_t offset)
{
	...
	((SCB_Type *) ((0xE000E000) + 0x0D00))->VTOR  = offset;
}

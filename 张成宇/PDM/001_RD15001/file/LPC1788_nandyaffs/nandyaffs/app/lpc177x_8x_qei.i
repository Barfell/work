#line 1 "..\\Drivers\\lpc177x_8x_qei.c"
...
#line 1 "..\\Drivers\\lpc177x_8x_qei.h"
...
#line 32 "..\\Drivers\\lpc177x_8x_qei.h"
...
#line 33 "..\\Drivers\\lpc177x_8x_qei.h"
...
#line 99 "..\\Drivers\\lpc177x_8x_qei.h"
...
#line 161 "..\\Drivers\\lpc177x_8x_qei.h"

 

 
#line 183 "..\\Drivers\\lpc177x_8x_qei.h"

 

 
#line 205 "..\\Drivers\\lpc177x_8x_qei.h"

 

 
#line 227 "..\\Drivers\\lpc177x_8x_qei.h"

 

 
#line 249 "..\\Drivers\\lpc177x_8x_qei.h"

 

 
#line 271 "..\\Drivers\\lpc177x_8x_qei.h"
...
#line 318 "..\\Drivers\\lpc177x_8x_qei.h"
...
typedef struct
{
	uint32_t PHA_FilterVal;
	uint32_t PHB_FilterVal;
	uint32_t INX_FilterVal;
} st_Qei_FilterCfg;
...
#line 27 "..\\Drivers\\lpc177x_8x_qei.c"
...
#line 28 "..\\Drivers\\lpc177x_8x_qei.c"
...
LPC_QEI_TypeDef* QEI_GetPointer(uint8_t qeiId)
{
	LPC_QEI_TypeDef* pQei = ((void*) 0);

	if(qeiId == 0)
	{
		pQei = ((LPC_QEI_TypeDef *) ((0x40080000UL) + 0x3C000) );
	}
...
void QEI_Init(uint8_t qeiId, QEI_CFG_Type *QEI_ConfigStruct)
{
	...
	pQei->LOAD = 0x00;
	pQei->CON = ((uint32_t)(1<<0)) | ((uint32_t)(1<<2)) | ((uint32_t)(1<<3));
	...
	pQei->IEC = ((uint32_t)(0xFFFF));

	
	pQei->CLR = ((uint32_t)(0xFFFF));
...
uint32_t QEI_CalculateRPM(uint8_t qeiId, uint32_t ulVelCapValue, uint32_t ulPPR)
{
	...
	clock = CLKPWR_GetCLK(((uint32_t)(1)));

	
	Load  = (uint64_t)(pQei->LOAD + 1);

	
	edges = (uint64_t)((pQei->CONF & ((uint32_t)(1<<2))) ? 4 : 2);

#line 1 "..\\Drivers\\lpc177x_8x_uart.c"
...
#line 28 "..\\Drivers\\lpc177x_8x_uart.c"
...
#line 29 "..\\Drivers\\lpc177x_8x_uart.c"
...
static Status uart_set_divisors(LPC_UART_TypeDef *UARTx, uint32_t baudrate)
{
	...
	if (relativeOptimalError < ((baudrate * (3))/100))
	{
		if (((LPC_UART1_TypeDef *)UARTx) == ((LPC_UART1_TypeDef *) ((0x40000000UL) + 0x10000) ))
		{
			...
			((LPC_UART1_TypeDef *)UARTx)->DLM = (((diviserOptimal) >> 8) & 0xFF);

			((LPC_UART1_TypeDef *)UARTx)->DLL = ((diviserOptimal) & 0xFF);

			 
			((LPC_UART1_TypeDef *)UARTx)->LCR &= (~((uint8_t)(1<<7))) & ((uint8_t)(0xFF));

			((LPC_UART1_TypeDef *)UARTx)->FDR = (((uint32_t)((mulFracDivOptimal<<4)&0xF0)) 													| ((uint32_t)(dividerAddOptimal&0x0F))) & ((uint32_t)(0xFF));
		...
		else
		{
			...
			UARTx->DLM = (((diviserOptimal) >> 8) & 0xFF);

			UARTx->DLL = ((diviserOptimal) & 0xFF);

			 
			UARTx->LCR &= (~((uint8_t)(1<<7))) & ((uint8_t)(0xFF));

			UARTx->FDR = (((uint32_t)((mulFracDivOptimal<<4)&0xF0)) 							| ((uint32_t)(dividerAddOptimal&0x0F))) & ((uint32_t)(0xFF));
...
void UART_RS485Config(LPC_UART_TypeDef *UARTx, UART1_RS485_CTRLCFG_Type *RS485ConfigStruct)
{
	...
	if (RS485ConfigStruct->AutoDirCtrl_State == ENABLE)
	{
		...
		if ((RS485ConfigStruct->DirCtrlPin == UART1_RS485_DIRCTRL_DTR)
								&& ((LPC_UART1_TypeDef *)UARTx == ((LPC_UART1_TypeDef *) ((0x40000000UL) + 0x10000) )))
		{
			tmp |= ((uint32_t)(1<<3));
		}

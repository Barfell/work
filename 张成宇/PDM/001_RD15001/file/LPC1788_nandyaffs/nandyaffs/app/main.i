...
#line 8 "main.c"
#line 1 "..\\Drivers\\lpc177x_8x_nvic.h"
...
#line 33 "..\\Drivers\\lpc177x_8x_nvic.h"
#line 34 "..\\Drivers\\lpc177x_8x_nvic.h"
...
#line 13 "main.c"
#line 1 "..\\Drivers\\lpc177x_8x_gpio.h"
...
#line 27 "..\\Drivers\\lpc177x_8x_gpio.h"
#line 28 "..\\Drivers\\lpc177x_8x_gpio.h"
...
{
	_db_msg_((LPC_UART_TypeDef *)((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) ), boot_msg);
}
...
{
	_db_msg_((LPC_UART_TypeDef *)((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) ), menu);
}
...
void fstest(void)
{
    ...
    _db_msg_((LPC_UART_TypeDef *)((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) ), "yaffs start up");

    i=yaffs_mount("//");
    
    if(i != 0)
    {
        _db_msg_((LPC_UART_TypeDef *)((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) ), "yaffs mount error");
        while(1);
    }
    else
    {
        _db_msg_((LPC_UART_TypeDef *)((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) ), "yaffs mount finsh");
    }
    
    i=yaffs_mkdir("/heyuanjie",0040000);
    if(i != 0)
    {
        _db_msg_((LPC_UART_TypeDef *)((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) ), "yaffs mkdir error");
    }
    else
    {
        _db_msg_((LPC_UART_TypeDef *)((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) ), "yaffs mkdir finsh");
    }

    
    file= yaffs_open("/heyuanjie/a.txt", 0100 | 02 | 02000, 0000400 | 0000200);

    
    _db_msg_((LPC_UART_TypeDef *)((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) ), "yaffs open finsh");
    
    _db_hex_32_((LPC_UART_TypeDef *)((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) ), file);

    _db_msg_((LPC_UART_TypeDef *)((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) ), "yaffs write");
    i=yaffs_write(file,BufWriteTo,256);
    
    _db_hex_32_((LPC_UART_TypeDef *)((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) ), i);

    
    
    
    
    _db_msg_((LPC_UART_TypeDef *)((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) ), "yaffs read");
    i=yaffs_pread(file,BufToRead,256,0);

    _db_hex_32_((LPC_UART_TypeDef *)((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) ), i);
    
    for(i=0;i<256;i++)
        _db_dec((LPC_UART_TypeDef *)((LPC_UART_TypeDef *) ((0x40000000UL) + 0x0C000) ), BufToRead[i]);

...
int yaffs_WriteChunkWithTagsToNAND(yaffs_Device * dev, int chunkInNAND,const __u8 * buffer,yaffs_ExtendedTags * tags)
 {
	...
	if (tags) {
		...
		do{ if((0x00000080) & (yaffs_traceMask | 0xF0000000)) ;} while(0);
	...
	if (dev->writeChunkWithTagsToNAND)
 		return yflash2_WriteChunkWithTagsToNAND(dev, chunkInNAND, buffer,tags);

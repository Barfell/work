...
#line 15 "..\\fs\\yaffs_packedtags2.c"
#line 16 "..\\fs\\yaffs_packedtags2.c"
...
#line 17 "..\\fs\\yaffs_packedtags2.c"
...
{
	do{ if((0x00004000) & (yaffs_traceMask | 0xF0000000)) ;} while(0);
...
void yaffs_PackTags2TagsPart(yaffs_PackedTags2TagsPart * ptt, const yaffs_ExtendedTags * t)
{
	...
	if (t->chunkId == 0 && t->extraHeaderInfoAvailable) {
		...
		ptt->chunkId = 0x80000000
			| t->extraParentObjectId;
		if (t->extraIsShrinkHeader) {
			ptt->chunkId |= 0x40000000;
		}
		if (t->extraShadows) {
			ptt->chunkId |= 0x20000000;
		}

		ptt->objectId &= ~((0x0F) << (28));
		ptt->objectId |=
		    (t->extraObjectType << (28));
...
void yaffs_UnpackTags2TagsPart(yaffs_ExtendedTags * t, yaffs_PackedTags2TagsPart * ptt)
{
	...
	if (ptt->sequenceNumber != 0xFFFFFFFF) {
		...
		if (ptt->chunkId & 0x80000000) {
			t->chunkId = 0;
			t->byteCount = 0;

			t->extraHeaderInfoAvailable = 1;
			t->extraParentObjectId =
			    ptt->chunkId & (~(0xF0000000));
			t->extraIsShrinkHeader =
			    (ptt->chunkId & 0x40000000) ? 1 : 0;
			t->extraShadows =
			    (ptt->chunkId & 0x20000000) ? 1 : 0;
			t->extraObjectType =
			    ptt->objectId >> (28);
			t->objectId &= ~((0x0F) << (28));

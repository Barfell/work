...
#line 18 "..\\fs\\yaffs_tagscompat.c"

static void yaffs_HandleReadDataError(yaffs_Device * dev, int chunkInNAND);
#line 29 "..\\fs\\yaffs_tagscompat.c"
...
#line 333 "..\\fs\\yaffs_tagscompat.c"
...
#line 404 "..\\fs\\yaffs_tagscompat.c"
					    ...
					    int blockInNAND)
{
	...
	yaffs_WriteChunkToNAND(dev, blockInNAND * dev->nChunksPerBlock, 0,
			       &spare);
					  ...
					  __u32 *sequenceNumber)
{
	...
	*sequenceNumber = 0;
	...
	yaffs_ReadChunkFromNAND(dev, blockNo * dev->nChunksPerBlock, 0,
				&spare0, &dummy, 1);
	yaffs_ReadChunkFromNAND(dev, blockNo * dev->nChunksPerBlock + 1, 0,
				&spare1, &dummy, 1);

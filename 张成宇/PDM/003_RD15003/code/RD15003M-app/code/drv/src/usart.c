...
EXTERN CSysRunInfo cSysRunInfo;
...
STATIC VOID ReceiveUsartData(U8 type)
{
    ...
    switch(type)
    {
        case USART1_TYPE:
			...
			if(cSysRunInfo.bImu == TRUE)
			{
				
				u32SynCnt = GetEtrSynCount();
				if(u32SynCnt != 0)
				{
//					g_pUsart1_rx_buf[u16RxDataCount] = 9 ;
//					g_pUsart1_rx_buf[u16RxDataCount + 1] = 9 ;
//					g_pUsart1_rx_buf[u16RxDataCount + 2] = 9 ;
//					g_pUsart1_rx_buf[u16RxDataCount + 3] = 9 ;
//					g_pUsart1_rx_buf[u16RxDataCount + 4] = *g_pSyndataCount ;
//					g_pUsart1_rx_buf[u16RxDataCount + 5] = *(g_pSyndataCount + 1) ;
//					g_pUsart1_rx_buf[u16RxDataCount + 6] = *(g_pSyndataCount + 2) ;
//					g_pUsart1_rx_buf[u16RxDataCount + 7] = *(g_pSyndataCount + 3) ;

//					u16RxDataCount = g_cUsart1Info.UsartRxCount + 8;
					g_pUsart1_rx_buf[u16RxDataCount + 0] = *g_pSyndataCount ;
        ...
        case USART2_TYPE:
			...
			if(cSysRunInfo.bImu == TRUE)
			{
				u16RxDataCount = 46;
				u32SynCnt = GetEtrSynCount();
				*(g_pUsart2_rx_buf + 1) = (u32SynCnt/1000000000)+'0' ;
				*(g_pUsart2_rx_buf + 2) = ((u32SynCnt/100000000)%10)+'0' ;
				*(g_pUsart2_rx_buf + 3) = ((u32SynCnt/10000000)%10)+'0' ;
				*(g_pUsart2_rx_buf + 4) = ((u32SynCnt/1000000)%10)+'0' ;
				*(g_pUsart2_rx_buf + 5) = ((u32SynCnt/100000)%10)+'0' ;
				*(g_pUsart2_rx_buf + 6) = ((u32SynCnt/10000)%10)+'0' ;
				*(g_pUsart2_rx_buf + 7) = ((u32SynCnt/1000)%10)+'0' ;
				*(g_pUsart2_rx_buf + 8) = ((u32SynCnt/100)%10)+'0' ;
				*(g_pUsart2_rx_buf + 9) = ((u32SynCnt/10)%10)+'0' ;
				*(g_pUsart2_rx_buf + 10) = (u32SynCnt%10)+'0' ;
	...
	if((cSysRunInfo.bSave == FALSE) && (cSysRunInfo.bStart == TRUE))
	{
